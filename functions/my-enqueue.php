...
function mytheme_enqueue()
{
  ...
  wp_enqueue_style('google-fonts-notoserifJP', 'https://fonts.googleapis.com/css2?family=Noto+Serif+JP:wght@300;400;500;700&display=swap" rel="stylesheet"', false);
  wp_enqueue_style('google-fonts-playfairdisplay', 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;700&display=swap rel="stylesheet"', false);
  wp_enqueue_style('google-fonts-kaisei', 'https://fonts.googleapis.com/css2?family=Kaisei+Opti:wght@400;500;700&display=swap rel="stylesheet"', false);
